  ...
  return (
    ...
    >
      <div className="relative left-0 top-0 h-3/5 w-full rounded-t-lg">
        <img
          src={`${import.meta.env.VITE_TMDB_IMAGE_BASE_URL}/${backdrop_path}`}
          alt="image placeholder"
          className={`h-full w-full rounded-t-lg object-cover brightness-[0.70] ${isHovered ? 'brightness-100' : 'brightness-[0.70]'} transition-all duration-500 ease-in-out`}
        />
