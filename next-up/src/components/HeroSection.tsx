...
const HeroSection = () => {
  ...
  return (
    <>
      <div className="w-1/3 grid grid-cols-2 grid-rows-6 gap-4">
        <div className="col-span-2 row-span-2 rounded-lg">
          <img
            src={`https://image.tmdb.org/t/p/w500${movies[0].backdrop_path}`}
            alt={movies[0].title}
            className="size-full rounded-lg bg-cover bg-center object-cover"
          />
        </div>
        ...
        <div className="col-span-2 row-span-1 flex items-center justify-center gap-4">
      ...
      <div className="w-1/3 grid grid-cols-3 grid-rows-5 gap-4">
        ...
        <div className="col-span-1 row-span-2 ">
          <img
            ...
            alt={movies[7].title}
            className="size-full rounded-lg bg-cover bg-center "
          />
        </div>
        <div className="col-span-1 row-span-2 ">
          <img
