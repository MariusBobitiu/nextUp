    ...
    <>
      {isAuthenticated ? (
        <div className="size-full flex">
          <div className='container mx-auto h-full flex flex-col justify-normal items-start gap-2'>
            ...
            <div className="flex w-full items-center justify-between gap-12 rounded-lg bg-gradient-to-b from-secondary-500 to-secondary-700 px-12 py-8">
              ...
              <div className="mr-4">
                <h3 className="text-2xl text-primary-200 flex items-center gap-2"><FilledBookmark className='size-6 inline-block text-accent' />WatchList</h3>
                <p className="text-lg">
            ...
            <div className="flex h-3/4 flex-col items-start justify-normal gap-4 overflow-auto p-4">
                ...
                >
                  ...
                  <div className="z-10 ml-4 flex h-full flex-col items-start justify-normal gap-2">
                    ...
                    <div className='flex items-center gap-2'>
                      <p className="text-lg">Rating: {movie.vote_average} ⭐️</p>
                    ...
                    <p className='flex items-center gap-2'>
                      {movie.genres?.map((genre) => (
                        <span
                          key={genre.id}
                          className="rounded-lg px-2 py-1 border bg-secondary-800/50 backdrop-blur-xl"
                        >
                          {genre.name}
                        </span>
                      ))}
